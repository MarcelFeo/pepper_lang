...
# region Helper
class FunctionParameter(Expressions):
    def __init__(self, name: Expressions = None, param_type: str = None) -> None:
        self.name = name
...
class CallExpression(Expressions):
    def __init__(self, function: Expressions = None, arguments: list[Expressions] = None) -> None:
